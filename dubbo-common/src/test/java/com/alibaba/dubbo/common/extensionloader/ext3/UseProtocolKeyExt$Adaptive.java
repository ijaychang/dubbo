...
public class UseProtocolKeyExt$Adaptive implements com.alibaba.dubbo.common.extensionloader.ext3.UseProtocolKeyExt {
    ...
    // com.alibaba.dubbo.common.extensionloader.ext3.UseProtocolKeyExt#yell接口方法加了@Adaptive({"protocol", "key2"})注解，所以生成的代码String extName = url.getProtocol() == null ? (url.getParameter("protocol","impl1")) : url.getProtocol();
